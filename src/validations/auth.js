...
export const registerValidation = [
    body('username').isString().withMessage('Username debe ser un String').isLength({
        min: 4,
        max: 20
    }).withMessage('El usuario debe tener una longitud de 4 a 20 caracteres'),
...
export const loginValidation = [
    body('username').isString().isLength({min: 4, max: 20}).withMessage('El usuario debe tener una longitud de 4 a 20 caracteres'),
    body('password').isString().isLength({
        min: 4,
        max: 50
    }).withMessage('La clave debe tener una longitud minima de 4 caracteres y una maxima de 50')
];
